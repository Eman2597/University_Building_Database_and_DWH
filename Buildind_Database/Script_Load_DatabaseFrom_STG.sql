...
SELECT DISTINCT [department], [specialization], (N'Ìœ—” '+[department]+N' ‘⁄»…'+[specialization]) [PDescription]
FROM [UniversityDB].[STG].[Data]
--where [Teacher_department] is not null;
Go
GO
...
SELECT [w] AS [QuestionID], N' ﬁÌÌ„ „Õ ÊÏ «·„ﬁ——' AS [QuestionCategory], [ ﬁÌÌ„ „Õ ÊÏ «·„ﬁ——] AS [QuestionText]
FROM [UniversityDB].[STG].[Question_Text]
where [w] is not null
Go
----------------
INSERT INTO [Feedback].[Feedback_Questions] ([QuestionID], [QuestionCategory], [QuestionText])
SELECT [x] AS [QuestionID], N' ﬁÌÌ„ ⁄÷Ê ÂÌ∆… «· œ—Ì”' AS [QuestionCategory], [ ﬁÌÌ„ ⁄÷Ê ÂÌ∆… «· œ—Ì”] AS [QuestionText]
FROM [UniversityDB].[STG].[Question_Text]
where [x] is not null
Go
------------------
INSERT INTO [Feedback].[Feedback_Questions] ([QuestionID], [QuestionCategory], [QuestionText])
SELECT [y] AS [QuestionID], N' ﬁÌÌ„ «·«„ Õ«‰«  Ê«· ﬂ·Ì›« ' AS [QuestionCategory], [ ﬁÌÌ„ «·«„ Õ«‰«  Ê«· ﬂ·Ì›« ] AS [QuestionText]
FROM [UniversityDB].[STG].[Question_Text]
where [y] is not null
Go
------------------
INSERT INTO [Feedback].[Feedback_Questions] ([QuestionID], [QuestionCategory], [QuestionText])
SELECT [z] AS [QuestionID], N' ﬁÌÌ„ ’›Õ… «·„ﬁ——' AS [QuestionCategory], [ ﬁÌÌ„ ’›Õ… «·„ﬁ——] AS [QuestionText]
FROM [UniversityDB].[STG].[Question_Text]
where [z] is not null
Go
-----------------
INSERT INTO [Feedback].[Feedback_Questions] ([QuestionID], [QuestionCategory], [QuestionText])
SELECT [Text] AS [QuestionID], N'«·√”∆·… «·„› ÊÕ…' AS [QuestionCategory], [«·√”∆·… «·„› ÊÕ…] AS [QuestionText]
FROM [UniversityDB].[STG].[Question_Text]
